...
:::tip
It's recommended to get acquainted with [Nominator Pool Specification](/v3/documentation/smart-contracts/contracts-specs/nominator-pool) before reading this tutorial.
:::
